    ...
    (() => {
      ...
      var r = function() {
        ...
        return t2 = e2, r2 = [{ key: "changeHeightWidth", value: function(e3, t3, a2, r3, n2, i) {
          ...
          var i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : "jpeg", o = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 100, l = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : 0, h = o / 100, g = document.createElement("canvas"), u = e3.width, d = e3.height, c = this.changeHeightWidth(d, a2, u, t3, r3, n2);
          !l || l !== 90 && l !== 270 ? (g.width = c.width, g.height = c.height) : (g.width = c.height, g.height = c.width), u = c.width, d = c.height;
          var s = g.getContext("2d");
          return s.fillStyle = "rgba(0, 0, 0, 0)", s.fillRect(0, 0, u, d), s.imageSmoothingEnabled && s.imageSmoothingQuality && (s.imageSmoothingQuality = "high"), l && (s.rotate(l * Math.PI / 180), l === 90 ? s.translate(0, -g.width) : l === 180 ? s.translate(-g.width, -g.height) : l === 270 ? s.translate(-g.height, 0) : l !== 0 && l !== 360 || s.translate(0, 0)), s.drawImage(e3, 0, 0, u, d), g.toDataURL("image/".concat(i), h);
          ...
          var h = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "base64", g = arguments.length > 8 && arguments[8] !== void 0 ? arguments[8] : null, u = arguments.length > 9 && arguments[9] !== void 0 ? arguments[9] : null, d = new FileReader();
          if (!t3)
